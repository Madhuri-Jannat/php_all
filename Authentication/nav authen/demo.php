  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarScroll">
      <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px;">
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="login2.php">Home</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="./page/page1.php">Page1</a>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="./page/page2.php" role="button" data-bs-toggle="dropdown" aria-expanded="false">
           Page2
          </a>
